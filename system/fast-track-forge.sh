...
echo "📥 Scaricamento del micro-container OCI ghcr.io/hr-mes/ermete-os-forge-$PACKAGE:latest..."
skopeo copy docker://ghcr.io/hr-mes/ermete-os-forge-$PACKAGE:latest dir:.
