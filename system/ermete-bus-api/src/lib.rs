...
//! Shared wire types and D-Bus proxy definitions used across the Ermete OS mesh/telemetry stack.
//!
...
/// whichever process actually registers `org.ermete.MeshBus` on the system
/// bus (see `system/ermete-mesh-bus`).
#[proxy(
