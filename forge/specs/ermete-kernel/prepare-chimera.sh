...
find . -type f \( -name "Makefile*" -o -name "Kbuild*" \) -exec sed -i 's/-Werror\b//g; s/-Werror=/-Wno-error=/g; s/-Wrestrict//g; s/-Wpacked-not-aligned//g; s/-Wstringop-truncation//g; s/-Wmaybe-uninitialized//g' {} + || true
