...
/// Applies capability dropping for ermete-ai-daemon
/// Retains: CAP_IPC_LOCK (14), CAP_SYS_NICE (23)
pub fn apply_ai_hardening() {
    match drop_capabilities(&[14, 23]) {
        Ok(_) => info!("🔒 Capability Dropping applied successfully for ermete-ai-daemon (Retained: CAP_IPC_LOCK, CAP_SYS_NICE)."),
