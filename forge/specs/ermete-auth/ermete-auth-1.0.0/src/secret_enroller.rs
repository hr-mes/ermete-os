...
impl SecretEnrollerService {
    ...
    pub fn seal_payload(password: &str, binding: &str) -> String {
    ...
    pub fn unseal_payload(sealed_hex: &str, binding: &str) -> Option<String> {
...
mod tests {
    use super::*;
    use crate::home_guard::HomeGuard;
    ...
    async fn test_enroll_and_decrypt_secret() {
        ...
        let _hg = HomeGuard::set(&temp_dir);
