...
Compiled natively in Ermete Forge for the Zero-Trust Mesh Network.
...
%changelog
* Thu Aug 20 2026 Ermete Forge <forge@ermete.os> - 0.2.1-1
- Integrazione PQC "La Via Purista" nello Swarm di Ermete OS
